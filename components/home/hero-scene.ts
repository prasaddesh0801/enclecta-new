...
export function createHeroScene({
  ...
  const starPalette = [
    new THREE.Color(P.accent), // Pantone 268C — bright
    new THREE.Color(P.accentSoft), // soft tint
    new THREE.Color(P.blue700), // Pantone 072C — deep
  ];
  ...
  function buildBrandMark() {
    ...
    c.shadowColor = hexToRgba(P.accentSoft, 0.85);
    c.shadowBlur = 28;
  ...
  function drawFullLine(L: any) {
    ...
    c.fillStyle = P.accentSoft;
    c.shadowColor = hexToRgba(P.accentSoft, 0.9);
    c.shadowBlur = 10 * QT;
